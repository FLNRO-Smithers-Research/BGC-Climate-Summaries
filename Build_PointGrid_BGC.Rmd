...
writeOGR (obj = p2, dsn = "./inputs/created/USA_HexGrid_800m_new.shp", 
...
write.csv (pts.info2,  "./inputs/created/USA_800m_Grid_Climate_new.csv", row.names = FALSE)         
...
#convert to SpatialPolygonsDataFrame
  o <- data.frame (ID1 = 1 :length(USA_BGC_hex))
    ...
    writeOGR (obj = USA_BGC_hex2, dsn = "./inputs/created/USA_HexPoly_800m_new.shp", layer = "HexPolys", driver = "ESRI Shapefile", overwrite_layer = TRUE)
